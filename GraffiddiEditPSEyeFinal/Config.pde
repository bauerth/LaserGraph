public static class Config {
  ...
  public static final float SpeedChange = (float) 2.5;
  public static final float SpeedInfluence = (float) 0.1;
  ...
  public static int cap_fps = 50;
  
  public static int imgWidth = 640;
  public static int imgHeight = 480;
  
  public static float blobThresh = 0.15;
  public static float bgThreshold = 10;
  
  public static String OSCRemoteLocation = "127.0.0.1";
